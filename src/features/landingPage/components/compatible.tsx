    ...
    return (
        <div className="flex flex-col lg:flex-row bg-custom-grey py-15 px-4 md:px-10 lg:px-20 gap-10">
            <div className="w-full lg:w-1/2">
                ...
                {data.map((item, index) => (
                    <div key={index} className="flex flex-col mt-6 text-sm md:pr-10">
                        <div className="flex items-start gap-4 justify-start">
                            <span className="shrink-0 p-2 bg-white rounded-lg shadow-sm">
                                {item.icon}
                            </span>
                            <div className="font-poppins">
                                <h3 className="font-semibold text-base mb-1">{item.header}</h3>
