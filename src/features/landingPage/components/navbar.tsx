...
function Navbar() {
    return (
        <nav className="flex justify-between items-center px-0 py-2 w-full max-w-360 mx-auto">
            <div className="">
            ...
            <div className="flex-1 md:flex justify-end items-center gap-6 font-poppins hidden ">
                <button className="bg-white cursor-pointer text-black px-4 py-2 rounded-full text-sm font-medium border border-gray-200 shadow-sm hover:bg-gray-50 hover:border-gray-500 transition-all duration-400">
                    Get a Demo
                </button>
